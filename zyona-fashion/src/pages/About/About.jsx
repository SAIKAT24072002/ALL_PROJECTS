...
const About = () => {
  return (
    <>
      <div className="text-2xl text-center pt-8 bo-t">
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          <p>
            <b className="text-2xl">Zyona</b> was born out of a passion for
          ...
          <p>
            Our mission at <b>ZYONA</b> is to empower customers with choice,
